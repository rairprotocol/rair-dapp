...
contract RAIR_ERC721 is IERC2981, ERC165, ERC721Enumerable, AccessControlEnumerable {
	struct collection {
		uint startingToken;
		uint endingToken;
		uint mintableTokens;
	...
	function mint(address to, uint collectionID) external onlyRole(MINTER) {
	...
	function supportsInterface(bytes4 interfaceId) public view virtual override(ERC165, AccessControlEnumerable, ERC721Enumerable, IERC2981) returns (bool) {
