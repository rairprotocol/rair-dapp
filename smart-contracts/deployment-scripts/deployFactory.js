...
const main = async () => {
	...
	let factoryInstance = await FactoryFactory.deploy(10, '0x51eA5316F2A9062e1cAB3c498cCA2924A7AB03b1');
	try {
		await factoryInstance.deployed();
	} catch (err) {
		console.error(err);
	}
	console.log('Your factory contract is deployed! Find it on address', factoryInstance.address);
