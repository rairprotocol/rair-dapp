...
const NavigatorContract = ({children, contractAddress, contractName}) => {
		...
		<div className={`col bg-${primaryColor} rounded-lg py-5`} style={{color: `var(--charcoal${primaryColor === 'rhyno' ? '' : '-40'})`}}>
			...
			<div className='row'>
				<div className='col-6 p-2'>
					<NavLink activeClassName={`btn-stimorol`} to={`/creator/contract/${contractAddress}/createCollection`} className={`btn btn-${primaryColor} w-100 rounded-rair`}>
