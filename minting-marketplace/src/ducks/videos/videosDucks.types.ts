...
import { getListVideosError, getVideoListComplete, getListVideosStart, refreshAction } from "./actions";
...
export type TVideosActions = TGetListVideosStart | TGetVideoListComplete | TRefreshAction | TGetListVideosError;