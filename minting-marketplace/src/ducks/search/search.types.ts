...
import { getDataAllClear, getDataAllComplete, getDataAllEmpty, getDataAllStart } from "./actions";
...
export type TSearchDataProduct = Pick<TProducts, "collectionIndexInContract" | "contract" | "_id" | "copies" | "cover" | "name">;
export type TSearchDataTokens = Pick<TTokenData, "contract" | "uniqueIndexInContract" | "_id" | "metadata">;
...
export type TSeacrhActionsType = TGetDataAllStart | TGetDataAllComplete | TGetDataAllEmpty | TGetDataAllClear;
