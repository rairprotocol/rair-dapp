...
export const TableAuthenticity = styled.div`
    background: ${(props) => props.primaryColor === "rhyno" ? "rgb(189, 189, 189)" : '#383637'};
    border-radius: 16px;
    padding-top: 10px;
    margin-top: 24px;
    ...
    .authenticity-box .link-block span {
        ...
        background: ${(props) => props.primaryColor === "rhyno" ? "#939393" : 'linear-gradient(0deg, #4E4D4D, #4E4D4D)'};
        border-radius: 16px;
        display: flex;
    ...
    .nftDataPageTest-a-hover:hover {
        color: ${(props) => props.primaryColor === "rhyno" ? '' : "var(--bubblegum)"};
    }    
`;
