      ...
      <div className="left-tokens-content">
        ...
        <div className={`tokens-description ${soldCopies === undefined && 'w-100'}`}>
          ...
          >
            ...
            we can see in each brush stroke the personality of the artist and
            that each time a brush stroke is made it’ll be different from the
            previous one, no matter how hard we try to create exactly the same
            one. So why try to make two identical paintings? On the other hand,
            in the digital world we can create exact copies in overabundance.
            When we create a digital image, we can multiply it as many times as
            we want just by the click of a button. We can also edit and animate
            the image, and each time we make a mistake there’s “control Z” to
          ...
          {showMore ? (
            ...
            >
              ...
              becomes a soundtrack for me to create. I don’t need to focus on
              the act of having music in my studio, it’s just there. Also, I
