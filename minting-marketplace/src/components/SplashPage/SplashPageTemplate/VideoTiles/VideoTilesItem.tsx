...
const VideoTilesItem = ({ videoName, videoType, videoTime, videoSRC, baseURL, mediaId, demo, backgroundImage }) => {
          ...
          <div className="box-video">
            ...
            >
              <div className="block-with-video" style={{ position: "relative" }}>
                ...
                <img className="block-img-bg static" src={backgroundImage} alt="demo video" />
              </div>
              <div className="video-description">
                <div className="video-title">
                  <p style={{ color: `${primaryColor === "rhyno" ? "#000" : "#fff"}` }}>{videoName}</p>
                </div>
                <div className="video-timer">
                  <p style={{ color: `${primaryColor === "rhyno" ? "#000" : "#A7A6A6"}` }}>{videoTime}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="box-video">
            <div
              ...
              <div className="block-with-video" style={{ position: "relative" }}>
                ...
                <img className="block-img-bg" src={videoSRC} alt="unlockable video" />
              </div>
              <div className="video-description">
                <div className="video-title">
                  <p style={{ color: `${primaryColor === "rhyno" ? "#000" : "#fff"}` }}>{videoName}</p>
