...
const teamTaxHacksSummit: TTeamArrayItemType[] = [
  {
    chain: '',
    ...
    <div className="splash-team">
      <div className="title-team">
        ...
        {arraySplash === 'ukraine' && (
          <h3>
            {' '}
            About the <span style={{ color: '#035BBC' }}>Cause</span>
          </h3>
        )}
        ...
        {arraySplash === 'slidelock' && (
          <h3>
            {' '}
            Meet the <span style={{ color: '#57B69C' }}>Team</span>
          </h3>
        )}
        {arraySplash === 'nipsey' && (
          <h3>
        ...
        {arraySplash === 'rair-advisors' && (
          <h3>
            About our <span className="text-gradient">Advisors</span>
          </h3>
        )}
        {arraySplash === 'nuts' && (
          <h3>
