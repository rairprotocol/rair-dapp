...
const CompareMobileSelect: React.FC<ICompareMobileSelect> = ({ categories }) => {
    return (
        <div className="compare-select-mobile-container">
            {
                categories === 10 && <div className="compare-mobile-deployment">
            ...
            {
                categories === 20 && <div className="compare-mobile-deployment">
                    <div className="block-logos-mobile">
                        <div className="block-logo">
                            <div>
                                <img src={RairLogo} alt="rair tech" />
            ...
            {
                categories === 30 && <div className="compare-mobile-deployment">
                    <div className="block-logos-mobile">
                        <div className="block-logo">
                            <div>
                                <img src={RairLogo} alt="rair tech" />
            ...
            {
                categories === 40 && <div className="compare-mobile-deployment">
                    <div className="block-logos-mobile">
                        <div className="block-logo">
                            <div>
                                <img src={RairLogo} alt="rair tech" />
            ...
            {
                categories === 50 && <div className="compare-mobile-deployment">
                    <div className="block-logos-mobile">
                        <div className="block-logo">
                            <div>
                                <img src={RairLogo} alt="rair tech" />
