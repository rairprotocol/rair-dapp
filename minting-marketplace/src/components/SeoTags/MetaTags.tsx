...
const MetaTags = ({ seoMetaTags }) => {
    return (
        <Helmet>
            ...
            {seoMetaTags.image && <meta property="og:image" content={seoMetaTags.image} />}
            ...
            <link rel="apple-touch-icon" href="https://rair.mypinata.cloud/ipfs/QmNtfjBAPYEFxXiHmY5kcPh9huzkwquHBcn9ZJHGe7hfaW" />
        </Helmet>
    )
}
