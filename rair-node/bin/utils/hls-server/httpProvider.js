...
httpProvider.exists = (req, cb) => {
  // File exists and is ready to start streaming.
  // This is always true because all requests are proxied to the same stream
