...
module.exports = (context) => {
  context.agenda.define(AgendaTaskEnum.SyncContracts.enumVal(), { lockLifetime }, async (task, done) => {
    try {
      logAgendaActionStart({agendaDefinition: AgendaTaskEnum.SyncContracts.enumVal()});
