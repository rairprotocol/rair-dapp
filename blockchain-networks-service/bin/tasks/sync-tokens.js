...
module.exports = (context) => {
  context.agenda.define(AgendaTaskEnum.SyncTokens.enumVal(), { lockLifetime }, async (task, done) => {
    try {
      logAgendaActionStart({agendaDefinition: AgendaTaskEnum.SyncTokens.enumVal()});
