...
* [x] /api
    ...
    * [x] /tokenGroups - POST - create new contract, [see details here](readme/create_tokenGroup.md)
        * [x] / - GET - get list of contracts for specific user, [see details here](readme/get_tokenGroups.md)
            * [x] /:tokenGroupAddress - GET - get specific contract, [see details here](readme/get_single_tokenGroup.md)
            * [x] /:tokenGroupAddress - DELETE - remove specific contract, [see details here](readme/delete_tokenGroup.md)
